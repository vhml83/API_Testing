...
Feature: Test the Pet Store REST API
  ...
  @PET @NEGATIVE
  Scenario: GET a pet's data with an empty id
    Given A GET request is made to get single pet with id: ""
    Then the response code is 405
    Then the response status line is "HTTP/1.1 405 Method Not Allowed"
    Then the response headers contain "Content-Type"
    Then the content type header equals "application/json"
    Then the response body is not null
  ...
  @STORE
  Scenario: Get Find Purchase Order With Valid Id
    Given A GET request is made to get the purchase order with id: "5"
    Then the response code is 200
    Then the response status line is "HTTP/1.1 200 OK"
    Then the response headers contain "Content-Type"
    Then the content type header equals "application/json"
  ...
  @STORE @NEGATIVE
  Scenario: Get Find Purchase Order With an Id out of range '0'
    Given A GET request is made to get the purchase order with id: "0"
    Then the response code is 404
    Then the response status line is "HTTP/1.1 404 Not Found"
    Then the response headers contain "Content-Type"
    Then the content type header equals "application/json"
    Then the response body is not null
    Then the response body message contains: "Order not found"

  @STORE @NEGATIVE
  Scenario: Get Find Purchase Order With an Id out of range '10'
    Given A GET request is made to get the purchase order with id: "10"
    Then the response code is 404
    Then the response status line is "HTTP/1.1 404 Not Found"
    Then the response headers contain "Content-Type"
    Then the content type header equals "application/json"
  ...
  @STORE @NEGATIVE
  Scenario: Get Find Purchase Order With an invalid ID '5ABC'
    Given A GET request is made to get the purchase order with id: "5ABC"
    Then the response code is 404
    Then the response status line is "HTTP/1.1 404 Not Found"
    Then the response headers contain "Content-Type"
    Then the content type header equals "application/json"
  ...
  @STORE
  Scenario: Delete Purchase Order With Valid Id
    Given A DELETE request is made to delete a purchase order by id: "5"
    Then the response code is 200
    Then the response status line is "HTTP/1.1 200 OK"
    Then the response headers contain "Content-Type"
    Then the content type header equals "application/json"
  ...
  @STORE @NEGATIVE
  Scenario: Delete Purchase Order that has been deleted
    Given A DELETE request is made to delete a purchase order by id: "5"
    Then the response code is 404
    Then the response status line is "HTTP/1.1 404 Not Found"
    Then the response headers contain "Content-Type"
